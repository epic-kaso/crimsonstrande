...
(function ($) {
    ...
    $.extend(SVGWrapper.prototype, {
        _width: function () {
            ...
            return this._makeNode(e.parent, 'clipPath', $.extend({id: e.id, clipPathUnits: e.units}, e.settings || {}))
            ...
            k = (typeof k == 'boolean' ? {addTo: k} : (typeof k == 'function' ? {onLoad: k} : (typeof k == 'string' ? {parent: k} : (typeof k == 'object' && k.nodeName ? {parent: k} : (typeof k == 'object' && k.jquery ? {parent: k} : k || {})))));
            if (!k.parent && !k.addTo) {
                this.clear(false)
            }
            ...
            var p = function (a) {
                ...
                if (!k.changeSize) {
                    m.configure(d, {width: l[0], height: l[1]})
                }
                if (k.onLoad) {
            ...
            if (j.match('<svg')) {
                ...
                $.ajax({
                    url: j, dataType: ($.browser.msie ? 'text' : 'xml'), success: function (a) {
